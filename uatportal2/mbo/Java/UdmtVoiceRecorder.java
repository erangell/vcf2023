 ...
 *
 */
public class UdmtVoiceRecorder extends Object	{
//JPanel implements ActionListener, UdmtControlContext {
    ...
    static int[] FlatYellowRight = {0,0,
    ...
    static int[] SharpYellowLeft = {0,0,
    ...
    static int[] SharpYellowRight = {0,0,
    ...
    class SamplingGraph extends JPanel implements Runnable {
	    ...
	    int[] validSamples = new int[88200];
	    ...
	    double[] fftmagnitude = new double[65536];
			...
			numValidSamples++;
		     ...
		     int lowFreqFilter = 120;
		     int highFreqFilter = 2048;
...
//            }
    ...
    public static void main(String s[]) 
	{
		try { 
			...
			logfile.write("UdmtVoiceRecorder.java started.  Frequency Magnitudes:\r\n");
        ...
        UdmtVoiceRecorder capturePlayback = new UdmtVoiceRecorder();
