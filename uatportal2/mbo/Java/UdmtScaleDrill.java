//------------------------------------------------------------------------------
// UdmtScaleDrill Applet -  Scale Drill and Exam for Major and Minor Scales
//------------------------------------------------------------------------------
...
//				Values: 	MajorAsc, MajorDesc
//						NaturalMinorAsc, NaturalMinorDesc
//						HarmonicMinorAsc, HarmonicMinorDesc, 
//						MelodicMinorAsc, MelodicMinorDesc
//						AllMinorAscMixed
//				REQUIRED
//
...
public class UdmtScaleDrill extends Applet
	implements MouseListener, MouseMotionListener, ActionListener, ItemListener

//------------------------------------------------------------------------------
{
	private String udmtAppletName			=	"UdmtScaleDrill";
	...
	private String parmScaleType 			= 	"MajorAsc"; //default = major scale ascending.
	...
	private String strInstruct3 			= 	" scale beginning on the given tonic note.";
...
//------------------------------------------------------------------------------
	...
	public void init()
	{
		...
		if (parmScaleType == null)
		{
			...
			dispScaleType="diatonic ascending Major";
			upDown = +1;
			strDrillMode="Major Scale Practice";
			strExamMode="Major Scale Exam";
			majorOrMinor = +1;
		}
		else if  (parmScaleType.equals("MajorDesc"))	{
			for (int i=0 ; i<=6 ; i++)			{
				ScaleBeingTested[i] = MajorScaleDesc[i];
			}
			dispScaleType="diatonic descending Major";
			upDown = -1;
			strDrillMode="Major Scale Practice";
			strExamMode="Major Scale Exam";
			majorOrMinor = +1;
		}
		else if  (parmScaleType.equals("NaturalMinorAsc"))	{
			for (int i=0 ; i<=6 ; i++)				{
		...
		else if  (parmScaleType.equals("NaturalMinorDesc"))	{
			for (int i=0 ; i<=6 ; i++)				{
				ScaleBeingTested[i] = NaturalMinorScaleDesc[i];
			}
			dispScaleType="diatonic descending Natural Minor";
			upDown = -1;
			strDrillMode="Minor Scale Practice";
			strExamMode="Minor Scale Exam";
			majorOrMinor = -1;
			...
			for (int i=0 ; i<=6 ; i++)				{
				ScaleBeingTested[i] = HarmonicMinorScaleDesc[i];
			}
			dispScaleType="diatonic descending Harmonic Minor";
			upDown = -1;
			strDrillMode="Minor Scale Practice";
			strExamMode="Minor Scale Exam";
			majorOrMinor = -1;
			...
			for (int i=0 ; i<=6 ; i++)				{
				ScaleBeingTested[i] = MelodicMinorScaleDesc[i];
			}

			dispScaleType="diatonic descending Melodic Minor";
			upDown = -1;
			strDrillMode="Minor Scale Practice";
			strExamMode="Minor Scale Exam";
			majorOrMinor = -1;
