...
09/20/2011 - ver 0.96 slowed down the game by using _timeParm, added parm: Animate
*/
...
//------------------------------------------------------------------------------
	...
	public void init()
	{
		...
		//2011-09-24: Only show buttons if playing animated game
//
//	CHECK button setup
//
...
//			numTimesChecked++;
			...
			if ( examMode )	{
				...
				//2011-09-24: removing next button requires calling this
