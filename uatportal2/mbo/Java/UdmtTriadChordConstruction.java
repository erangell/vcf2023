//------------------------------------------------------------------------------
// UdmtTriadChordConstruction Applet -  Triad Identification Drill and Exam
//------------------------------------------------------------------------------
// PARAMS:
//
...
public class UdmtTriadChordConstruction extends Applet implements ActionListener, ItemListener, MouseListener, MouseMotionListener
{
	...
	private String udmtAppletName			=	"UdmtTriadChordConstruction";
...
//	private UdmtMidiInQueue		midiIn;
	...
	private String strInstruct			= "Please construct the following triad:";
			...
			txtError = "Parameter nextURL is required";
 			...
 			if (examMode)
 			{
 				UdmtExamKey objEk = new UdmtExamKey();
  				String sExamKey = objEk.getExamKey("TriadChordConstrPass");
		...
		if ( examMode )	{
			...
			if ( parmDrillURL == null )	{
				...
				txtError				= "Parameter drillURL is required for Exam Mode";
 				...
 				{
 					UdmtExamKey objEk = new UdmtExamKey();
  					String sExamKey = objEk.getExamKey("TriadChordConstrFail");
...
//------------------------------------------------------------------------------
	...
	private	char accidToCharDisp(int a)
	{
		char		ac				=	' ';
		//String	accString = "Ff sSn";
		String	accString = "Fb #x ";
...
//------------------------------------------------------------------------------
	...
	public void PresentCurrentQuestion(int q)
	{
		...
		currentStudentRomanNumeral = "X";
			//GetRomanNumeral((qAnswer[q])%10,kapital);
		...
		correctRootAc = accidToCharDisp(acnum);
		correctRootNote = startNote;

		char theNoteName = ' ';
		theNoteName = RowToPitchChar(correctRootNote, currentClef); 
		currentStudentRomanNumeral = "" + theNoteName + correctRootAc;
