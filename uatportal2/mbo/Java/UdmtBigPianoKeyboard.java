...
//---------------------------------------------------------------------------------
public class UdmtBigPianoKeyboard extends Component
//---------------------------------------------------------------------------------
{
	...
	public void ProcessMetaEvent( MetaMessage msg )
	{
		...
		if (theMessage[1] == 35)
		{
			//System.out.println("UdmtBigPianoKeyboard.ProcessMetaEvent NOTE ON :"+theMessage[2]);
			int midinote = (int)theMessage[2];
			setPianoDot(midinote,1);
		}
		else if (theMessage[1] == 33)
		{
			//System.out.println("UdmtBigPianoKeyboard.ProcessMetaEvent NOTE OFF:"+theMessage[2]);
			int midinote = (int)theMessage[2];
...
//---------------------------------------------------------------------------------
// END OF CLASS UdmtBigPianoKeyboard
//---------------------------------------------------------------------------------
