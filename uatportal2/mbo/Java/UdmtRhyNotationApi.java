...
//------------------------------------------------------------------------------
// UdmtRhyNotationApi - Interprets command strings of notation rendering commands
...
public class UdmtRhyNotationApi extends Object
{
	private String UdmtAppletVersion = "0.07";
...
//----------------------------------------------------------------------------
	...
	private void renderTimeSig (int num, int den)
	{
		...
		if (den == 2) // common or cut time or 3/2
		{
			switch (num)
			{
				case 2: {  
