//------------------------------------------------------------------------------
// UdmtTriadChordID Applet -  Triad Identification Drill and Exam
//------------------------------------------------------------------------------
// PARAMS:
//
...
public class UdmtTriadChordID extends Applet implements ActionListener, ItemListener, MouseListener, MouseMotionListener
{
	...
	private String udmtAppletName			=	"UdmtTriadChordID";
			...
			txtError = "Parameter nextURL is required";
 			...
 			if (examMode)
 			{
 				UdmtExamKey objEk = new UdmtExamKey();
  				String sExamKey = objEk.getExamKey("TriadChordIDPass");
		...
		if ( examMode )	{
			...
			if ( parmDrillURL == null )	{
				...
				txtError				= "Parameter drillURL is required for Exam Mode";
 				...
 				{
 					UdmtExamKey objEk = new UdmtExamKey();
  					String sExamKey = objEk.getExamKey("TriadChordIDFail");
...
//
		...
		LetterA = new Button("A");
		LetterA.addActionListener(this);
		LetterA.setEnabled(true);
		LetterA.setBounds(PITCH_BOX_X1+0*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterA);

		LetterB = new Button("B");
		LetterB.addActionListener(this);
		LetterB.setEnabled(true);
		LetterB.setBounds(PITCH_BOX_X1+1*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterB);

		LetterC = new Button("C");
		LetterC.addActionListener(this);
		LetterC.setEnabled(true);
		LetterC.setBounds(PITCH_BOX_X1+2*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterC);

		LetterD = new Button("D");
		LetterD.addActionListener(this);
		LetterD.setEnabled(true);
		LetterD.setBounds(PITCH_BOX_X1+3*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterD);

		LetterE = new Button("E");
		LetterE.addActionListener(this);
		LetterE.setEnabled(true);
		LetterE.setBounds(PITCH_BOX_X1+4*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterE);

		LetterF = new Button("F");
		LetterF.addActionListener(this);
		LetterF.setEnabled(true);
		LetterF.setBounds(PITCH_BOX_X1+5*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterF);

		LetterG = new Button("G");
		LetterG.addActionListener(this);
		LetterG.setEnabled(true);
		LetterG.setBounds(PITCH_BOX_X1+6*PITCH_BOX_SEP, PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(LetterG);


		btnSharpTriad = new Button("#");
		btnSharpTriad.addActionListener(this);
		btnSharpTriad.setEnabled(true);
		btnSharpTriad.setBounds(PITCH_BOX_X1+2*PITCH_BOX_SEP, PITCH_BOX_Y2, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(btnSharpTriad);


		btnFlatTriad = new Button("b");
		btnFlatTriad.addActionListener(this);
		btnFlatTriad.setEnabled(true);
		btnFlatTriad.setBounds(PITCH_BOX_X1+3*PITCH_BOX_SEP, PITCH_BOX_Y2, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(btnFlatTriad);

		btnNaturalTriad = new Button("natural");
		btnNaturalTriad.addActionListener(this);
		btnNaturalTriad.setEnabled(true);
		btnNaturalTriad.setBounds(PITCH_BOX_X1+0*PITCH_BOX_SEP, PITCH_BOX_Y2, PITCH_BOX_SEP+PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(btnNaturalTriad);
		...
		btnMinTriad.setBounds(PITCH_BOX_X1+9*PITCH_BOX_SEP,  PITCH_BOX_Y1, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(btnMinTriad);
		...
		btnAugTriad.setBounds(PITCH_BOX_X1+8*PITCH_BOX_SEP, PITCH_BOX_Y2, PITCH_BOX_WIDTH, PITCH_BOX_HEIGHT);
		add(btnAugTriad);
...
//------------------------------------------------------------------------------
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ( e.getActionCommand().equals("+") ) {
			currentStudentChordQuality = "aug";
			csqual=2;
			repaint();
		} 
		else if ( e.getActionCommand().equals("o") ) {
			currentStudentChordQuality = "dim";
			csqual=3;
			repaint();
		}
			...
			csnumeral = 0;
			currentStudentNoteLetter = "C";
			repaint();
		}
		else if ( e.getActionCommand().equals("D") ) {
			csnumeral = 2;
			currentStudentNoteLetter = "D";
			repaint();
		}
		else if ( e.getActionCommand().equals("E") ) {
			csnumeral = 4;
			currentStudentNoteLetter = "E";
			repaint();
		}
		else if ( e.getActionCommand().equals("F") ) {
			csnumeral = 5;
			currentStudentNoteLetter = "F";
			repaint();
		}
		else if ( e.getActionCommand().equals("G") ) {
			csnumeral = 7;
			currentStudentNoteLetter = "G";
			repaint();
		}
		else if ( e.getActionCommand().equals("A") ) {
			csnumeral = 9;
			currentStudentNoteLetter = "A";
			repaint();
		}
		else if ( e.getActionCommand().equals("B") ) {
			csnumeral = 11;
			currentStudentNoteLetter = "B";
			repaint();
		}
		...
		if ((currentStudentNoteLetter == "") || (currentStudentChordQuality == "")) 
		{
			checkButton.setEnabled(false);
		}
		else
		{
			...
			if (currentStudentNoteAccid == "#")
			{ 
				currentAnswer += 1000;
			}
			else if (currentStudentNoteAccid == "b")
			{
				currentAnswer += 3000;
			}
			currentAnswer += (csqual) * 10000;
		...
		if ( e.getActionCommand().equals("SHOW CORRECT") )	{
			...
			strFeedback = "Answer: "+pName+DisplayAnswer(qAnswer[currQues]);
			repaint();
		}
		//
...
//------------------------------------------------------------------------------
	...
	public void GenerateQuestionDeck()
	{
		...
		qAnswer[q] = (rootMidi % 12)+noteAccid*1000+qTriadQuality[q]*10000;
...
//------------------------------------------------------------------------------
	...
	private void displayScore(Graphics g)
	{
		...
		String currentStudentChord = currentStudentNoteLetter + currentStudentNoteAccid +" "+ dispCurrentStudentChordQuality;
